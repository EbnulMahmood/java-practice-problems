...
public class Animal {
	...
	public void setFavChar() {
		...
		if (randomNumber == 32) {
			...
			System.out.println("Favorite charecter set to space");
		}
		else if (randomNumber == 10) {

			System.out.println("Favorite charecter set to newline");
		}
		else {

			System.out.println("Favorite character set to " + this.favChar);
		}
